...
module.exports = {
    ...
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'xchamod' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? 'xEW6JeJXhyeSueNYb5kt7DNmwjX6Po3xaE9l' : process.env.GITHUB_AUTH_TOKEN, //ADD YOUR GITHUB AUTH TOKEN WITHOUT gph_ ,  example - G5OxxdvEbiBPWxm4A0xypQGlyCr4FS267ifz
